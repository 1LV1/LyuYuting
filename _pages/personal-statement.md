...
During the following semester, I focused on my coursework and managed to achieve a 3.65 overall GPA. Additionally, I had the opportunity to work in the STM laboratory, which focuses on silicon-based quantum dot quantum computing. Here, I developed my skills in STM hydrogen lithography for silicon-based samples, including important steps such as sample degassing, flashing, H cover preparation, and tip electrochemical etching. I also gained experience in STM hydrogen lithography, dosing, incorporation, and MBE encapsulation. As part of a research group that evaluates scientific research work every semester, I am proud to say that I consistently received the top grade among my peers.
